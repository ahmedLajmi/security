...
<title>Détails du personne</title>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-10 col-md-pull-1 animate-box">
						<form:form modelAttribute="person" action="${person.id}"
							method="post">
							<div class="row form-group">
								...
								<div class="col-md-4">
									...
									<form:input path="firstName" class="form-control"
										placeholder="Votre prénom" readonly="true" />
								</div>
								<div class="col-md-4">
									<label for="lname">Nom</label>
									<form:input path="lastName" class="form-control"
										placeholder="Votre nom" readonly="true" />
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<form:input path="address" class="form-control"
										placeholder="Votre adresse" readonly="true" />
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<form:input path="birthDay" class="form-control" type="date"
										placeholder="Your subject of this message" readonly="true" />
								</div>
							</div>
						</form:form>
					</div>
